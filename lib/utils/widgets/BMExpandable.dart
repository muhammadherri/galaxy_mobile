// ignore_for_file: file_names, prefer_const_declarations, unnecessary_this, avoid_renaming_method_parameters, annotate_overrides, use_key_in_widget_constructors, library_private_types_in_public_api, provide_deprecation_message, prefer_generic_function_type_aliases, prefer_conditional_assignment
...
class ExpandableThemeData {
  static final ExpandableThemeData defaults = const ExpandableThemeData(
  ...
  /// If true, the header of [BMExpandablePanel] can be clicked by the user to expand or collapse.
  final bool? tapHeaderToExpand;

  /// If true, the body of [BMExpandablePanel] can be clicked by the user to expand.
  final bool? tapBodyToExpand;

  /// If true, the body of [BMExpandablePanel] can be clicked by the user to collapse.
  final bool? tapBodyToCollapse;

  /// If true, an icon is shown in the header of [BMExpandablePanel].
  final bool? hasIcon;
...
/// Determines the placement of the expand/collapse icon in [BMExpandablePanel]
...
class BMExpandablePanel extends StatelessWidget {
