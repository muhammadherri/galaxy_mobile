// ignore_for_file: file_names, use_key_in_widget_constructors, prefer_equal_for_default_values, unnecessary_this, library_private_types_in_public_api, sized_box_for_whitespace
import 'dart:async';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:flutter/material.dart';

class BMCarouselSlider extends StatefulWidget {
  BMCarouselSlider(
  ...
  /// The initial page to show when first creating the [BMCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [BMCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [BMCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [BMCarouselSlider].
  ///
  ...
  /// Animates the controlled [BMCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _BMCarouselSliderState createState() => _BMCarouselSliderState();
}

class _BMCarouselSliderState extends State<BMCarouselSlider>
