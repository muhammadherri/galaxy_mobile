...
const Profile = 'images/user';
const IconsDashboard = 'images/icons/menu';
const IconsSettings = 'images/icons/setting';
const IconsNavbar = 'images/icons/navbar';
const Article = 'images/article';
const Banner = 'images/banner';
const Themes = 'images/theme';
...
// Slide Screen Awal Splash
const String ml_ic_slide_one = '$Splash/ml_splash_one.png';
const String ml_ic_slide_two = '$Splash/ml_splash_two.png';
const String ml_ic_slide_three = '$Splash/ml_splash_three.png';
